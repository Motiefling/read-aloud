...
def _translate_and_tts_chapter(
    ...
    try:
        ...
        api_client.mark_chapter_translated(chapter_id, title_english)
...
def dispatcher_loop(self):
    ...
    while True:
        try:
            ...
            # Load term dictionary (cached per novel)
            if novel_id != cached_novel_id:
                cached_term_dict = load_dictionary(novel_id)
            ...
            if novel_id not in translated_title_novels:
                ...
                if title and contains_chinese(title):
                    try:
                        translated = translator.translate_title(title, cached_term_dict)
            ...
            logger.info(
                ...
                novel_id, chapter_number, ready, total,
            )
            ...
            success = _translate_and_tts_chapter(
                ...
                novel_id, job_id,
                translator, cached_term_dict, tts_engine, output_dir,
            )
