...
class TranslationSettings(BaseModel):
    ...
    system_prompt: str = (
        ...
        "- The body of the translation MUST be English prose. Do NOT output "
        "pinyin or romanized Mandarin for the narrative — sentences, "
        "dialogue, and description must read as natural English.\n"
        "- Pinyin is allowed ONLY for proper nouns (character names, place "
        "names, sect/clan names, technique names). Everything else is "
        "English.\n"
        "- Your output must contain ZERO Chinese characters.\n"
